...
export default function Page() {
  ...
  return (
    <SafeAreaView className="bg-general-500">
      {errorMsg && (
        <View className="h-[80px] bg-red-500 justify-center items-center">
          <Text className="text-lg text-white font-Jakarta">
            Map Permission required!{" "}
            <Text
              onPress={requestLocation}
              className="font-JakartaExtraBold underline"
            >
              Allow
            </Text>
          </Text>
          ...
          <>
            <View className="flex flex-row items-center justify-between my-5">
              <Text
                ...
                className="text-2xl capitalize font-JakartaExtraBold"
              >
                <Text className="text-xl font-Jakarta">Welcome,</Text>{" "}
                {user?.firstName ||
